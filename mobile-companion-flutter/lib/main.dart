...
class _MainScreenState extends State<MainScreen> {
  ...
  Future<void> _saveServerUrl() async {
    ...
    if (url.isNotEmpty) {
      ...
      _showToast('Configuration Saved', 'Target endpoint updated successfully.');
    }
  }
  ...
  void _handleDeepLink(Uri uri) {
    ...
    try {
      ...
      if (queryParams.containsKey('platform') && queryParams.containsKey('token')) {
  ...
  Future<void> _submitCookiesToServer(String cookieString) async {
    ...
    try {
      debugPrint('Syncing cookies with server $_serverUrl for platform $_platform');
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        throw Exception(response.body.isNotEmpty ? response.body : 'Server responded with status ${response.statusCode}');
      }
    } catch (e) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Column(
          ...
          children: [
            Text(title, style: const TextStyle(color: Color(0xFF06B6D4), fontWeight: FontWeight.bold)),
  ...
  void _showAlert(String title, String message) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(title, style: const TextStyle(color: Color(0xFF06B6D4), fontFamily: 'monospace')),
              ...
              children: [
                InAppWebView(
                  ...
                  onUpdateVisitedHistory: (controller, url, isReload) async {
                    ...
                    bool loggedIn = false;
                    if ((p == 'twitter' || p == 'x') && (urlStr.contains('twitter.com/home') || urlStr.contains('x.com/home'))) {
                      loggedIn = true;
                    } else if (p == 'instagram' && (urlStr == 'https://www.instagram.com/' || urlStr == 'https://www.instagram.com/home/')) {
                      loggedIn = true;
                    } else if (p == 'linkedin' && urlStr.contains('linkedin.com/feed')) {
                      loggedIn = true;
                    } else if (p == 'facebook' && (urlStr.contains('facebook.com/home') || urlStr.contains('m.facebook.com/home'))) {
                      loggedIn = true;
                    } else if (p == 'pinterest' && urlStr.contains('pinterest.com/')) {
                      loggedIn = true;
                    }
